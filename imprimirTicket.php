...
$sentenciaProductos = $base_de_datos->prepare("SELECT p.nombre, p.nombre,p.precio, pv.cantidad
FROM productos p
INNER JOIN 
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="producto"><?php echo $producto->nombre;  ?> <strong><br>$<?php echo number_format($producto->precio, 2) ?></strong></td>
